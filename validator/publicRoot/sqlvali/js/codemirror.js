...
window.CodeMirror = (function () {
    ...
    function updateDisplayInner(cm, changes, visible, forced) {
        ...
        if (maybeUpdateLineNumberWidth(cm))
            changes = [
                {from: doc.first, to: doc.first + doc.size}
            ];
    ...
    function markText(doc, from, to, options, type) {
        ...
        if (posLess(to, from) || posEq(from, to) && type == "range" && !(options.inclusiveLeft && options.inclusiveRight))
            return marker;
    ...
    var isExtendingChar = /[\u0300-\u036F\u0483-\u0487\u0488-\u0489\u0591-\u05BD\u05BF\u05C1-\u05C2\u05C4-\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7-\u06E8\u06EA-\u06ED\uA66F\u1DC0â€“\u1DFF\u20D0â€“\u20FF\uA670-\uA672\uA674-\uA67D\uA69F\udc00-\udfff\uFE20â€“\uFE2F]/;
